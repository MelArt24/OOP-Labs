...
class ShapeObjectsEditor(Shape, ShapeEditor):
    def __init__(self, root):
        ...
        self.shapes = [None] * 112  # Статичний масив з 112 елементів
        ...
        #             return
        #
        #         # Створюємо нове вікно для підказки
        ...
        self.button1 = tk.Button(self.toolbar, image=self.icon1, relief=tk.RAISED, command=toggle_button1)
        self.button1.pack(side=tk.LEFT)
        ToolTip(self.button1, "Point")
        ...
        self.button2 = tk.Button(self.toolbar, image=self.icon2, relief=tk.RAISED, command=toggle_button2)
        self.button2.pack(side=tk.LEFT)
        ToolTip(self.button2, "Line")
        ...
        self.button3 = tk.Button(self.toolbar, image=self.icon3, relief=tk.RAISED, command=toggle_button3)
        self.button3.pack(side=tk.LEFT)
        ToolTip(self.button3, "Rectangle")
        ...
        self.button4 = tk.Button(self.toolbar, image=self.icon4, relief=tk.RAISED, command=toggle_button4)
        self.button4.pack(side=tk.LEFT)
        ToolTip(self.button4, "Ellipse")
    ...
    def create_tool_button(self, icon, tooltip_text, command):
        button = tk.Button(self.toolbar, image=icon, relief=tk.RAISED, command=lambda: command(button))
